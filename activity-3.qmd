...
In this activity we revisit the prenatal vitamins / preterm birth / smoking example from Activities 1–2. We make the effect stronger (OR = 0.8) and use simulation to see how precision (ASE, ESE) and our ability to detect a clear difference (power) change as sample size grows, and what the resulting confidence intervals look like. Then we'll turn the question around and ask what effect sizes are detectable at a fixed sample size.
